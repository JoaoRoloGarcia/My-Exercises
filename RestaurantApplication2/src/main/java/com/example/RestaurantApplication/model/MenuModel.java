...
public class MenuModel {
	...
	public String toString() {
		return "MenuModel [dish_id=" + dish_id + ", dish_name=" + dish_name + ", dish_availability=" + dish_availability
				+ ", dish_on_sale=" + dish_on_sale + ", dish_selling_period=" + dish_selling_period + "]";
	}
	
	public MenuModel(Integer dish_id, String dish_name, Boolean dish_availability, Boolean dish_on_sale,
